...
shinyServer(function(input, output) {
   ...
   TweetFrame<-function(twtList)
  {
	...
	pos.words = scan('G:/projects/summer_sentiment_analysis/positiveWords.txt', what='character', comment.char=';')
	neg.words = scan('G:/projects/summer_sentiment_analysis/negativeWords.txt', what='character', comment.char=';')
